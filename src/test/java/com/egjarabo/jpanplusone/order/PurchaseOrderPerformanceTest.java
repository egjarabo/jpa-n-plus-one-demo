...
@SpringBootTest
class PurchaseOrderPerformanceTest {
    ...
    @Test
    void analyzeNaivePerformance() {
        // 1. Limpiamos métricas anteriores
        stats.clear();

        // 2. Ejecutamos y medimos tiempo
        long startTime = System.nanoTime();
        List<PurchaseOrderResponse> results = purchaseOrderService.findAllNaive();
        ...
        printReport("findAllNaive (N+1)", queryCount, totalTimeMs, results.size());
    }
